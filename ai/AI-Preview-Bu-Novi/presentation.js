...
class PresentationEngine {
      ...
      <div style="display:flex; flex-direction:column; height:100%; justify-content:center; align-items:center; text-align:center;">
        ...
        <div style="display:flex; gap:16px;">
          <button class="btn-primary" onclick="window.location.hash='slide-2'">
            <i data-lucide="play" class="icon"></i> Mulai Presentasi
          </button>
          <a href="../" class="btn-secondary">Lihat Program Lengkap</a>
        </div>
      </div>
    `;
  }
      ...
      <div style="display:flex; flex-direction:column; height:100%;">
        ...
        <div class="grid-2">
          ...
          <div style="display:flex; flex-direction:column; justify-content:center;">
            <p style="font-size:14px; color:rgba(255,255,255,0.5); margin-bottom:12px; text-transform:uppercase; letter-spacing:0.05em;">Hasil Prompt AI (Bahasa Inggris)</p>
            <div class="prompt-preview" id="prompt-preview-box">
              ${initialPrompt}
            </div>
            <button class="btn-secondary" id="btn-copy-prompt" style="align-self:flex-start;">
              <i data-lucide="copy" class="icon"></i> Salin Prompt
            </button>
          </div>
        </div>
      </div>
      ...
      <div style="display:flex; flex-direction:column; height:100%;">
        ...
        <div class="grid-2" style="flex:1;">
          ...
          <div style="display:flex; flex-direction:column; justify-content:center; padding-left:24px;">
            <h3 style="color:var(--accent-teal); font-size:20px; margin-bottom:24px;">Yang Ditambahkan ke Video:</h3>
      ...
      <div style="display:flex; flex-direction:column; height:100%;">
        ...
        <div class="info-card" style="background:rgba(109,40,217,0.1); border-color:var(--purple-soft); padding:24px 32px; display:flex; gap:24px; align-items:center;">
          <div style="flex:1;">
            ...
            <p style="margin:0; font-size:15px; opacity:0.8;">Praktik yang diterapkan selama kelas berlangsung.</p>
          </div>
          <div style="flex:2;">
    ...
    return `
      <div style="display:flex; flex-direction:column; height:100%;">
        ...
        <div style="text-align:center; padding:32px; background:rgba(255,255,255,0.03); border-radius:12px; margin-bottom:auto;">
          <span style="display:block; font-size:14px; color:var(--accent-cyan); text-transform:uppercase; letter-spacing:0.05em; margin-bottom:8px;">Hasil Akhir Siswa</span>
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; padding-top:24px; border-top:1px solid rgba(255,255,255,0.1);">
          ...
          <div style="display:flex; gap:16px;">
            <button class="btn-secondary" onclick="window.location.hash='slide-1'">Kembali ke Awal</button>
            <a href="../#curriculum" class="btn-primary">Lihat Kurikulum Lengkap</a>
          </div>
        </div>
      </div>
    `;
  ...
  goToSlide(index, updateHash = true) {
    ...
    this.noteContent.textContent = this.slides[index].presenterNote || "Tidak ada catatan untuk slide ini.";
    this.nextPreview.textContent = index < this.totalSlides - 1 ? `Slide ${index + 2}: ${this.slides[index+1].title}` : "Akhir presentasi.";
